"""
This file is a copy of the Dawid-Skene method included in crowd-kit==1.4.0.
Behavior differs between crowd-kit<1.4.0 and later versions.
While experiments generally use crowd-kit<1.4.0, 
the HS-DS_EM method utilizes the DS from crowd-kit==1.4.0 for internal processing.
Therefore, a copy is stored in this folder.
Copyright follows the crowd-kit license.
"""
